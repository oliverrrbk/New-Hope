...
export const PricingCard = ({
  ...
  return (
    <div className={cardClasses.trim()}>
      {isPopular && (
        <div className={`absolute -top-3 -right-2 md:-top-2.5 md:-right-1 2xl:-top-3 2xl:right-3 rounded-full bg-gradient-to-r from-[#A88A77] to-[#FCD12A] md:bg-none p-[2px] md:p-0 opacity-60 md:opacity-100`}>
          <div className={`px-3 py-1 md:px-2 md:py-0.5 2xl:px-2.5 2xl:py-1 text-[10.5px] md:text-[8px] 2xl:text-[9px] font-medium md:font-semibold rounded-full ${t.badgeBg} h-full w-full flex items-center justify-center bg-white`}>
            <span className="md:hidden bg-gradient-to-r from-[#A88A77] to-[#FCD12A] bg-clip-text text-transparent">Mest populær</span>
